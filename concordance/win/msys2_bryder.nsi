...
Section "Concordance"
  ...
  File "$%MINGW_SYSROOT_BIN%\\libgcc_s_seh-1.dll"
  File "$%MINGW_SYSROOT_BIN%\\libstdc++-6.dll"
  File "$%MINGW_SYSROOT_BIN%\\libzip.dll"
  File "$%MINGW_SYSROOT_BIN%\\zlib1.dll"
  File "$%MINGW_SYSROOT_BIN%\\libhidapi-0.dll"
  File "$%MINGW_SYSROOT_BIN%\\libwinpthread-1.dll"
  File "$%MINGW_SYSROOT_BIN%\\libbz2-1.dll"
  File "$%MINGW_SYSROOT_BIN%\\liblzma-5.dll"
#  File "\\tmp\\buildroot\\bin\\libconcord-5.dll"
  File "$%MINGW_SYSROOT%\\tmp\\buildroot\\bin\\libconcord-5.dll"
  File "$%MINGW_SYSROOT%\\tmp\\buildroot\\bin\\concordance.exe"
